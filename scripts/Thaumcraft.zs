...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("ARCANESTONE", "", 5, [<aspect:ignis>*2, <aspect:terra>*2,], <thaumcraft:stone_arcane>*8, [[<ore:stone>, <botania:livingrock>, <ore:stone>], [<botania:livingrock>, <thaumcraft:crystal_essence>, <botania:livingrock>], [<ore:stone>, <botania:livingrock>, <ore:stone>]]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapelessRecipe("BASICARTIFACE", "MIRROR@1", 1, [<aspect:terra>*10, <aspect:ignis>*10], <thaumcraft:mirrored_glass>, [<thaumcraft:quicksilver>, <botania:managlasspane>]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("ENCHFABRIC", "UNLOCKINFUSION@2", 1, [<aspect:aer>*1, <aspect:ignis>*1, <aspect:aqua>*1, <aspect:ordo>*1, <aspect:perditio>*1, <aspect:terra>*1], <thaumcraft:fabric>, [[null, <bewitchment:golden_thread>], [<minecraft:string>, <minecraft:wool:*>, <minecraft:string>], [null, <bewitchment:golden_thread>]]);

# -Candle
recipes.remove(<thaumcraft:candle_white>);
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("TALLOW", "HEDGEALCHEMY@1", 1, [<aspect:ignis>*2, <aspect:terra>*2], <thaumcraft:candle_white>*4, [[<ore:manaString>], [<thaumcraft:tallow>], [<thaumcraft:tallow>]]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("GOGGLES", "UNLOCKARTIFICE@2", 1, [<aspect:aer>*5, <aspect:ignis>*5, <aspect:aqua>*5, <aspect:terra>*5, <aspect:perditio>*5, <aspect:ordo>*5], <thaumcraft:goggles>, [[<harvestcraft:hardenedleatheritem>, <ore:ingotGold>, <harvestcraft:hardenedleatheritem>], [<harvestcraft:hardenedleatheritem>, null, <harvestcraft:hardenedleatheritem>], [<thaumcraft:thaumometer>, <ore:ingotGold>, <thaumcraft:thaumometer>]]);

# -Thaumium
mods.thaumcraft.Crucible.removeRecipe(<thaumcraft:ingot>);
mods.thaumcraft.Crucible.registerRecipe("THAUMIUM", "METALLURGY@1", <thaumcraft:ingot>, <botania:manaresource>, [<aspect:praecantatio>*4]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("JARLABEL", "WARDEDJARS", 1, [<aspect:aqua>], <thaumcraft:jar_normal>, [[<botania:managlasspane>, <thaumcraft:slab_greatwood>, <botania:managlasspane>], [<botania:managlasspane>, null, <botania:managlasspane>], [<botania:managlasspane>, <botania:managlasspane>, <botania:managlasspane>]]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("GOLEMWOOD", "MINDCLOCKWORK", 1, [<aspect:aqua>*4, <aspect:terra>*4, <aspect:ignis>*4, <aspect:aqua>*4, <aspect:ordo>*4, <aspect:perditio>*4], <thaumcraft:golem>.withTag({props: 282574488338432 as long}), [[<thaumcraft:log_greatwood>, <thaumcraft:log_greatwood>, <thaumcraft:log_greatwood>], [<bloodmagic:slate:1>, <thaumcraft:log_greatwood>, <bloodmagic:slate:1>], [<thaumcraft:log_greatwood>, <thaumcraft:log_greatwood>, <thaumcraft:log_greatwood>]]);
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("GOLEMIRON", "MINDCLOCKWORK", 1, [<aspect:aqua>*10, <aspect:terra>*10, <aspect:ignis>*10, <aspect:aqua>*10, <aspect:ordo>*10, <aspect:perditio>*10], <thaumcraft:golem>.withTag({props: 72341268037894144 as long}), [[<ore:ingotIron>, <ore:ingotIron>, <ore:ingotIron>], [<bloodmagic:slate:4>, <ore:blockIron>, <bloodmagic:slate:4>], [<ore:ingotIron>, <ore:ingotIron>, <ore:ingotIron>]]);
mods.thaumcraft.Infusion.registerRecipe("GOLEMTHAUMIUM", "MINDCLOCKWORK", <thaumcraft:golem>.withTag({props: 288515149663305728 as long}), 10, [<aspect:humanus>*8, <aspect:motus>*8, <aspect:spiritus>*8], <thaumcraft:golem>.withTag({props: 282574488338432 as long}), [<thaumcraft:ingot>, <thaumcraft:ingot>, <thaumcraft:ingot>, <thaumcraft:ingot>]);

# -Arcane Bore
mods.thaumcraft.Infusion.removeRecipe(<thaumcraft:turret:2>);
mods.thaumcraft.Infusion.registerRecipe("ARCANEBORE", "ARCANEBORE@2", <thaumcraft:turret:2>, 10, [<aspect:praemunio>*32, <aspect:machina>*32, <aspect:potentia>*16, <aspect:vacuos>*16, <aspect:motus>*16], <botania:lens:11>.withTag({}), [<thaumcraft:plank_greatwood>, <thaumcraft:plank_greatwood>, <minecraft:gold_ingot>, <minecraft:gold_ingot>, <thaumcraft:void_pick>, <bloodmagic:bound_shovel>.withTag({Unbreakable: 1 as byte, activated: 0 as byte}), <thaumcraft:mechanism_complex>, <thaumcraft:morphic_resonator>]);


#Steel
# -Steel Ingots
mods.thaumcraft.Infusion.registerRecipe("RESEARCH", "", <thermalfoundation:material:160>, 2, [<aspect:ignis>*8, <aspect:permutatio>*16, <aspect:metallum>*2], <minecraft:coal:1>, [<minecraft:iron_nugget>, <minecraft:iron_nugget>, <minecraft:iron_nugget>, <minecraft:iron_nugget>, <minecraft:coal:1>, <minecraft:iron_nugget>, <minecraft:iron_nugget>, <minecraft:iron_nugget>]);
